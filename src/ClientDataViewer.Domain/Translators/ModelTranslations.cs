...
public static class ModelTranslations
{
    ...
    {
        return new ClientDto(client.FirstName, client.LastName, client.BirthDate, ToGender(client.Gender), client.NativeId);
    }
    ...
    {
        return new ReportDto(report.Subject, report.Text, report.HasPriority, report.CarePlanGoalId, report.ClientId, report.CreatedBy, report.CreatedAt);
    }
